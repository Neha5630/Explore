    ...
    return (
        <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
          ...
          <div className='flex flex-col h-full justify-center'>
            ...
            <p className='text-2xl py-6'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita, quibusdam!</p>
            <p className='pb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet commodi molestiae sit quidem!</p>

          </div>
          <button className='border-black mr-4 hover:shadow-xl'>Learn More</button>
          <button className='bg-black text-white border-x-black hover:shadow-xl'>Book Your Trip</button>
    </div>
  )
}
